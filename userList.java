...
public class userList extends Thread {
    ...
    final String secretKey = "FloridaStateUniversity";
    ...
    public void run() {
        try {
            ...
            do {
                ...
                serverMessage = "[" + userName + "]: " + clientMessage;    //Message is sent to server
                serverMessage = encryption.encrypt(serverMessage, secretKey);
                hostUser.broadcast(serverMessage, this);
    ...
    void sendMessage(String message) {
        ...
        message = encryption.decrypt(message, secretKey);
        writer.println(message);        //message sent
    }
}